...
public:
    ...
    double vfov = 90; // TODO allow displaying as focal length in mm in gui
    // TODO expose sensor size and implement sensor size function
